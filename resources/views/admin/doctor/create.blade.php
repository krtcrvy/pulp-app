...
@section('title', 'Add Doctor | Pulp Dental Clinic')

@section('content')
    <h1 class="my-4 text-primary">Add Doctor</h1>
                    ...
                    <form action="{{ route('admin.doctors.store') }}" method="POST" id="addDoctorForm"
                        ...
                        <div class="d-grid gap-2 d-md-flex">
                            ...
                            <button type="button" class="btn btn-primary w-100" data-bs-toggle="modal"
                                data-bs-target="#confirmAddDoctorModal">
                                Add Doctor
                            </button>
    ...
    <div class="modal fade" id="confirmAddDoctorModal" tabindex="-1" aria-labelledby="confirmAddDoctorModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="confirmAddDoctorModalLabel">Confirm Add Doctor</h1>
