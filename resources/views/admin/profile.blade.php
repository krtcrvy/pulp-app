            ...
            <div class="card mb-4">
                <div class="card-body shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $user->admin->formatted_gender }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $user->admin->formatted_birthday }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $user->admin->address }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
