...
@section('title', 'Edit Admin | Pulp Dental Clinic')

@section('content')
    <h1 class="my-4 text-primary">Edit Admin</h1>
        ...
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-body shadow">
                    <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST" id="editAdminForm"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input id="contact_number" type="text"
                                        ...
                                        name="contact_number" value="{{ $admin->contact_number }}">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('birthday') is-invalid @enderror"
                                        id="birthday" name="birthday" value="{{ $admin->birthday }}" min="1950-01-01"
                                        max="2007-12-31">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('gender') is-invalid @enderror" id="gender"
                                        ...
                                        <option value="nonbinary" {{ $admin->gender == 'nonbinary' ? 'selected' : '' }}>
                                            Non-binary
                                        </option>
                                        <option value="transgender"
                                            {{ $admin->gender == 'transgender' ? 'selected' : '' }}>
                                            Transgender
                                        </option>
                                    </select>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="confirmEditAdminModalLabel">Confirm Add Admin</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to edit Admin?</p>
                </div>
