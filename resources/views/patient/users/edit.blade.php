        ...
        <div class="col">
            <div class="card mb-4">
                <div class="card-body shadow">
                    <form action="{{ route('patient.users.update', $user->id) }}" method="POST" id="editAdminForm"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('birthday') is-invalid @enderror"
                                        id="birthday" name="birthday" value="{{ $user->patient->birthday }}"
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('gender') is-invalid @enderror" id="gender"
                                        ...
                                        <option value="male" {{ $user->patient->gender == 'male' ? 'selected' : '' }}>
                                            Male
                                        </option>
                                        <option value="female" {{ $user->patient->gender == 'female' ? 'selected' : '' }}>
                                            Female
                                        </option>
                                        <option value="nonbinary"
                                            {{ $user->patient->gender == 'nonbinary' ? 'selected' : '' }}>
                                            Non-binary
                                        </option>
                                        <option value="transgender"
                                            {{ $user->patient->gender == 'transgender' ? 'selected' : '' }}>
                                            Transgender
                                        </option>
                                    </select>
                        ...
                        <div class="d-grid gap-2 d-md-flex">
                            ...
                            <a class="btn btn-secondary w-100" href="{{ route('patient.profile') }}"
