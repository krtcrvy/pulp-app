...
@section('title', 'Patient Dashboard | Pulp Dental Clinic')

@section('content')
    <h1 class="my-4 text-primary">Patient Dashboard</h1>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8 mx-auto my-auto">
                            <h1 class="mb-0">{{ $appointmentTotal }}</h1>
                            <p class="lead mb-0">Total Number of Appointments</p>
                        </div>
                    </div>
                </div>
            </div>
