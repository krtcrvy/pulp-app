            ...
            <div class="card mb-4">
                <div class="card-body shadow">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $user->doctor->formatted_gender }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $user->doctor->formatted_birthday }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <p class="text-muted mb-0">{{ $user->doctor->address }}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col">
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('doctor.users.edit', $user->id) }}" role="button"
